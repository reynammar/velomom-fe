...
const JournalSection = () => {
    return (
        <div className="px-[70px] overflow-hidden py-[120px] flex flex-col gap-5">
            {/* Header */}
            <div className="bg-gradient-to-b from-[#E6D4FF] via-[#E1CCFF] to-[#C8A3FF] pb-10 pt-[108px] rounded-3xl relative overflow-hidden">
                ...
                <div className="px-[250px] text-center text-third flex flex-col gap-4 mt-10">
            ...
            {/* Tombol tambah */}
            <div className="border-2 border-primary hover:border-white hover:bg-primary rounded-3xl flex justify-center py-8 group transition-all duration-300">
                <div className="flex items-center gap-6">
                    <div className="bg-primary group-hover:bg-white rounded-full w-12 h-12 flex items-center justify-center">
                        <FontAwesomeIcon icon={faPlus} className="text-2xl text-white group-hover:text-primary" />
                    </div>
                    <h3 className="font-semibold text-[38px] text-primary group-hover:text-white">Buat Jurnal</h3>
                </div>
            </div>
            {/* End tombol tambah */}
            ...
            <div className="flex gap-8">
                <div className="w-[70%] p-9 shadow-md rounded-3xl flex flex-col gap-[28px]">
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <div className="bg-pinkprimary py-1 px-6 rounded-xl flex justify-center items-center font-light text-[18px]">Frustasi</div>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <div className="bg-pinkprimary py-1 px-6 rounded-xl flex justify-center items-center font-light text-[18px]">Sedih</div>
                                    </div>
                                </div>
                                <div className="flex flex-col gap-2 text-secondary">
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <div className="bg-pinkprimary py-1 px-6 rounded-xl flex justify-center items-center font-light text-[18px]">Biasa</div>
                                    </div>
                                </div>
                                <div className="flex flex-col gap-2 text-secondary">
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <div className="bg-pinkprimary py-1 px-6 rounded-xl flex justify-center items-center font-light text-[18px]">Senang</div>
                                    </div>
                                </div>
                                <div className="flex flex-col gap-2 text-secondary">
                    ...
                    <div className="flex gap-4 items-center mt-6 justify-center">
                        <FontAwesomeIcon icon={faChevronDown} className="text-2xl text-primary" />
