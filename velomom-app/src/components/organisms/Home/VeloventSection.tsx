            ...
            <div className="w-full flex flex-col gap-12">
                ...
                <div className="flex flex-col justify-between items-center gap-11">
                    <div className="flex justify-between items-center gap-12">
                        <FontAwesomeIcon icon={faArrowLeft} className="border-[2px] border-purple500 rounded-full py-[7px] px-2 text-purple500" />
                        ...
                        <FontAwesomeIcon icon={faArrowRight} className="border-[2px] border-purple500 rounded-full py-[7px] px-2 text-purple500" />
                    </div>
                    <div className="flex gap-3">
                        <FontAwesomeIcon icon={faCircle} className="w-6 text-purple500" />
                        <FontAwesomeIcon icon={faCircle} className="w-6 text-purple100" />
                        <FontAwesomeIcon icon={faCircle} className="w-6 text-purple100" />
                        <FontAwesomeIcon icon={faCircle} className="w-6 text-purple100" />
                    </div>
                </div>
