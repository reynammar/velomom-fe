    ...
    return (
        <section className="w-full h-[400px] flex justify-center items-center px-[70px] my-10 overflow-hidden gap-14">
            ...
            <div className="flex flex-col w-[45%] gap-[28px]">
                ...
                <p className="text-secondary font-light text-[17px] text-justify">
                    <span className="text-third">Velomom</span> menyediakan dukungan bagi ibu pasca melahirkan melalui VeloCare yang menawarkan layanan emosional, VeloGuide dengan informasi terpercaya seputar kesehatan mental dan perawatan bayi, serta VeloVent yang menghadirkan webinar seputar kehidupan ibu. Dengan Velomom, ibu dapat melewati baby blues dengan lebih tenang dan percaya diri.
                </p>
            </div>
