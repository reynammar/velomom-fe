...
const VeloCareSection = () => {
    return (
        <section className="w-full flex items-center py-16 px-[70px] bg-hero overflow-hidden gap-6">
            <div className="flex flex-col w-full gap-[92px]">
            {/* Div title */}
                <div className="flex flex-col justify-center text-center gap-6 text-third w-full py-2.5">
                ...
                <div className="flex flex-col justify-center items-center gap-[108px]">
                    <div className="flex justify-center items-center gap-6">
                        <Link to="/journaling" className='bg-white/30 hover:bg-pink-200/50 text-secondary pt-[88px] pb-6 px-6 relative w-1/2 flex justify-center items-center flex-col gap-1 rounded-lg z-20 transition-all duration-400'>
