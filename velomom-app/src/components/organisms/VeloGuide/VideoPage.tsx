...
const VideoPage = () => {
    ...
    return(
        <div className="px-primaryPad overflow-hidden pt-[110px] pb-14 flex flex-col gap-10 w-full">
            <div className="flex gap-5">
                ...
                <div className="w-[70%] flex flex-col gap-9">
                    ...
                    <div className="flex flex-col gap-3">
                        <h4 className="font-semibold text-[32px] text-purple700 leading-[150%]">
                            Teknik Relaksasi Cepat untuk Ibu yang Sering Kewalahan
                        </h4>
                        <p className="font-light text-[17px] leading-[150%] text-purple900 text-justify">
                ...
                {/* Aside */}
                <div className="w-[38%] flex gap-5 pl-6 border-l-2 border-purple100 ">
                    <div className="flex flex-col gap-4">
                        <h5 className="font-semibold text-2xl leading-[150%] text-purple700">Video Lainnya</h5>
