...
// Ganti dengan path ke gambar emoticon Anda
const emoticons = [
            ...
            <div className="flex space-x-8 justify-between">
                {emoticons.map((emoticon) => (
                    <div
                        ...
                        className={`cursor-pointer p-2 rounded-lg hover:scale-125 transition-transform transform ${
                            selectedMood === emoticon.id ? 'scale-125' : ''
                        }`}
                    >
